...
## Project Structure
    ...
    ├── testingappactivity_111487  # Django project configurations
...
1. Clone this repo and `cd testingappactivity_111487`
...
2. Clone this repo and `cd testingappactivity_111487`
